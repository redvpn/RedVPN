...
class TunnelsManager {
    private let apiUrl = "https://partners.1e-100.net/api/myip/"
    ...
    static func create(completionHandler: @escaping (Result<TunnelsManager, TunnelsManagerError>) -> Void) {
        ...
        completionHandler(.success(TunnelsManager(tunnelProviders: RedVpnTunnel.createMockTunnels())))
        #else
...
class TunnelContainer: NSObject {
    ...
    @objc dynamic var redVpnStatus: TunnelStatus {
