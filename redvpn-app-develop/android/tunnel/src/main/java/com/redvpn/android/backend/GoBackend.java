...
package com.redvpn.android.backend;
...
public final class GoBackend implements Backend {
    private static final String TAG = "RedVPN/" + GoBackend.class.getSimpleName();
