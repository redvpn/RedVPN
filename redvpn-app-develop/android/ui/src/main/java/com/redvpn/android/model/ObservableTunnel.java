...
public class ObservableTunnel extends BaseObservable implements Keyed<String>, Tunnel {
    ...
    private RedVpnState redVpnState;
    ...
    ObservableTunnel(final TunnelManager manager, final String name,
        ...
        this.setRedVpnState(RedVpnState.OFF);
    }
    ...
    @Bindable
    public RedVpnState getRedVpnState() {
        return redVpnState;
    }
    ...
    public CompletionStage<State> setState(final State state) {
        if(state == State.UP)
            this.setRedVpnState(RedVpnState.CONNECTING);
    ...
    public void setRedVpnState(final RedVpnState redVpnState) {
        this.redVpnState = redVpnState;
        notifyPropertyChanged(BR.redVpnState);
    }
}
