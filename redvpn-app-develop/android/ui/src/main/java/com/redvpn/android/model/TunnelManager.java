...
package com.redvpn.android.model;
...
import com.redvpn.android.BR;
import com.redvpn.android.R;
import com.redvpn.android.configStore.ConfigStore;
import com.redvpn.android.backend.Tunnel;
import com.redvpn.android.backend.Tunnel.State;
import com.redvpn.android.backend.Statistics;
import com.redvpn.android.util.ExceptionLoggers;
import com.redvpn.android.util.ObservableSortedKeyedArrayList;
import com.redvpn.android.util.ObservableSortedKeyedList;
...
public final class TunnelManager extends BaseObservable {
    ...
    public static final class IntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, @Nullable final Intent intent) {
            ...
            if ("com.redvpn.android.action.REFRESH_TUNNEL_STATES".equals(action)) {
            ...
            final State state;
            if ("com.redvpn.android.action.SET_TUNNEL_UP".equals(action))
                state = State.UP;
            else if ("com.redvpn.android.action.SET_TUNNEL_DOWN".equals(action))
                state = State.DOWN;
            else
                return;
